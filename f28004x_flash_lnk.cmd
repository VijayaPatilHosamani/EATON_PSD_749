...
PAGE 0 :
   ...
   FLASH_BANK0_SEC1_2_3_4  : origin = 0x081000, length = 0x006000	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >>FLASH_BANK0_SEC1_2_3_4,   PAGE = 0, ALIGN(4)
   codestart           : > BEGIN       PAGE = 0,ALIGN(4)

   /* Allocate uninitalized data sections: */
   .cio                : > RAMLS0LS1LS2LS3       PAGE = 0
   .stack              : > RAMGS2      PAGE = 1
   .ebss               : > RAMLS5LS6LS7       PAGE = 1
   .esysmem            : > RAMLS5LS6LS7       PAGE = 1
   
   /* Initalized sections go in Flash */
   .econst          : > FLASH_BANK0_SEC8,    PAGE = 0, ALIGN(4)
